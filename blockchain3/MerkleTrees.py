    ...
    def create_tree(self):
        ...
        if len(transaction_list) != 1:
            ...
            for index in range(0, len(transaction_list), 2):
                ...
                left_leaf_hash = hashlib.sha256(left_leaf.encode("utf-8")).hexdigest()  # 左边叶子节点的哈希值
                right_leaf_hash = hashlib.sha256(right_leaf.encode("utf-8")).hexdigest()  # 右边叶子节点的哈希值
            ...
            root_leaf_hash = hashlib.sha256(root_leaf.encode("utf-8")).hexdigest()
